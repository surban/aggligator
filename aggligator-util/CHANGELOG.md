...
## 0.18.12 - 2026-07-31
### Changed
- update Aggligator to 0.9.12 to close a potential denial of service attack
  by a malicious remote endpoint causing memory exhaustion
...
## 0.18.8 - 2025-09-11
### Added
- forcefully terminate connections when termination signal is received
